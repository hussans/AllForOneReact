...
const ItalianRes = () => {
    const [message, setMessage] = useState('Click the button to get an Italian restaurant!');

    const getRestaurant = async () => {
        try {
            const response = await fetch('https://allforoneweb-g4fsepduf4ftc9fs.westus-01.azurewebsites.net/RestaurantPicker/PickItalianChineseOrMexican/italian');
    ...
    return (
        <div className="bg-[url('../public/assets/home.png')] bg-cover min-h-screen flex flex-col">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-4">
                <h1 className="text-white text-4xl font-bold mb-8"> Italian Restaurant </h1>
